...
class WalletTest {
    ...
    void wallet_1ParameterConstructor_Exists() throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        try {
            ...
            Class<Wallet> walletClass = Wallet.class;
            Constructor<Wallet> cons = walletClass.getConstructor(paramTypesTwo);
            Wallet instance = cons.newInstance(params);

            String actualNumCreditCardsString = getFieldValueInClassUsingReflection("numCreditCards", params, paramTypesTwo);
            String actualTotalCashString = getFieldValueInClassUsingReflection("totalCash", params, paramTypesTwo);

            int actualNumCreditCards = Integer.parseInt(actualNumCreditCardsString);
            String actualOwner = getFieldValueInClassUsingReflection("owner", params, paramTypesTwo);
    ...
    void wallet_3ParameterConstructor_Exists() throws InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException {
        try {
            ...
            Class<Wallet> walletClass = Wallet.class;
            Constructor<Wallet> cons = walletClass.getConstructor(paramTypesThree);
            Wallet instance = cons.newInstance(params);

            String actualNumCreditCardsString = getFieldValueInClassUsingReflection("numCreditCards", params, paramTypesThree);
            String actualTotalCashString = getFieldValueInClassUsingReflection("totalCash", params, paramTypesThree);

            int actualNumCreditCards = Integer.parseInt(actualNumCreditCardsString);
            String actualOwner = getFieldValueInClassUsingReflection("owner", params, paramTypesThree);
            double actualTotalCash = Double.parseDouble(actualTotalCashString);
