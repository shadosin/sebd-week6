...
class ToDoItemTest {
    static  final Object[] ITEM = {"walk the cat", "high"};
    public static Class<?>[] paramTypes = {String.class, String.class};

    static final String CLASS_NAME = "ToDoItem";
    ...
    void todoItem_2ParameterConstructor_Exists_Test() {
        try {
            ...
            Class<ToDoItem> toDoItemClass = ToDoItem.class;
            Constructor toDoItemConstructor = toDoItemClass.getConstructor(paramTypes);
            ToDoItem newToDoItem = (ToDoItem) toDoItemConstructor.newInstance(params);

            String actualDescription = getFieldValueInClassUsingReflection("description", params, paramTypes);
            String actualPriority = getFieldValueInClassUsingReflection("priority", params, paramTypes);
            boolean actualIsDone = Boolean.parseBoolean(getFieldValueInClassUsingReflection("isDone", params, paramTypes));
