...
class ClockTest {
    ...
    static final String CLASS_NAME = "Clock";
    static final Object[] CLOCK_ONE = {};
    static final Object [] CLOCK_TWO = {3, 15, "PM", "Central"};
    static final Object [] CLOCK_THREE = {15, 65, "morning", "new york"};
