...
class ToDoListTest {
    ...
    public static final Object[] TO_DO_LIST = {"personal errands", 9};
    public static final Class<?>[] PARAM_TYPES = {String.class, int.class};
    public static final Class<?>[] PARAM_TYPES_TODO = {String.class, String.class};
    ...
    void todoList_2ParameterConstructor_Exists() {
        try {
            ...
            Class<ToDoList> toDoListClass = ToDoList.class;
            Constructor<ToDoList> cons = toDoListClass.getConstructor(PARAM_TYPES);
            ToDoList instance = cons.newInstance(params);

            String actualItemList = getFieldValueInClassUsingReflection("itemList", params, PARAM_TYPES);
            String actualListName = getFieldValueInClassUsingReflection("listName", params, PARAM_TYPES);
            int actualMaxItems = Integer.parseInt(getFieldValueInClassUsingReflection("maxItems", params, PARAM_TYPES));
    ...
    void canGetAndSetField_itemList_Test() {
        try {
            ...
            Constructor toDoItemConstructor = ToDoItem.class.getConstructor(PARAM_TYPES_TODO);
    ...
    void canCreate_ToDoItem_Test() {
        try {
            Constructor toDoListConstructor = ToDoList.class.getConstructor(PARAM_TYPES);
